      ...
      <SceneDescription
        scene={{
          ...
          details: [
            ...
            {
              label: 'Северные полки',
              text: 'На верхних полках стоят запылённые банки с высохшими корнями и выцветшими этикетками.',
            },
            {
              label: 'Рабочий стол',
              text: 'На столе остались весы, ступка, несколько открытых книг и недописанные заметки.',
            },
            {
              label: 'Пол',
              text: 'Под ногами хрустят осколки тонкого стекла и рассыпанные сухие листья.',
            },
          ],
        }}
      />
