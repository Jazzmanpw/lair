...
import type {CreatureStatblock} from '@lair/domain/pf2e';
import type {EncounterSetup, ParticipantSetup} from '@lair/domain/prep';
import type {Participant} from '@lair/domain/running';
