...
2. Treat task files as discussion briefs unless they explicitly say implementation is ready.
3. Inspect the existing context, then clarify unresolved questions with the developer. Do not answer open product or domain questions on the developer's behalf.
4. Do not edit implementation until the developer and agent agree on what to prototype, which alternatives to compare, and what the prototype should test.
